      ...
      <div class="col-md-8 mt-4">
        ...
        <div class="container p-0 el-background-category el-shadow rounded  list-category mt-5 mb-4">
          <div class="container-fluid">
            <div class="row p-4">
              <p class="font-weight-bold mr-2"><?php echo $result = isset($showAll) ? count($showAll) : count($showAllCategory);?>  <span class="font-weight-normal"> khóa học </span> </p>
               <p class="font-weight-bold"> <?php echo $result = isset($showAll) ? count($showAll) : count($showAllCategory); ?><span class="font-weight-normal"> videos </span></p>
            </div>

            <!--box category-->
            <?php if(isset($showAll)):?>
            <?php foreach($showAll as $show): ?>
            <a href="course/<?php echo $show['course_slug'];?>">
              <div class="row p-4 list-category el-border">
                  ...
                  <div class="col-md-4 el-c-img p-0 ">
                    <div class="box-img rounded">
                      ...
                      <img src="public/images/<?php echo $show['course_gallery']; ?>" class="img-fluid">
                    </div>
                  </div>
                  <div class="col-md-8 pl-5">
                    <p class="font-weight-bold m-0 p-0"><?php echo $show['course_name']; ?></p>
                    <p><?php echo $show['author_name'] ?></p>
                    <p class="mt-5 pull-left"><?php echo $show['course_price'];?><sup>đ</sup> </p>
            ...
            <?php endforeach;?>
            <?php elseif(isset($showAllCategory)): ?>
            <?php foreach($showAllCategory as $show): ?>
            <a href="course/<?php echo $show['course_slug'];?>">
              <div class="row p-4 list-category el-border">
